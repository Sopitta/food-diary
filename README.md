...
If the signed URL has expired (~1 hour), upload again before estimating.
...
Vitest covers the high-risk server paths added/locked in recently (no browser/E2E suite yet):
